...
import { getActiveRoutes, getSalesFor } from "../../lib/supabase";
...
const BillHistory = () => {
  ...
  useEffect(() => {
    ...
    const loadRoutes = async () => {
      ...
      const filtered = data.filter((r) => shouldDisplayRoute(r.name));
  ...
  function normalizeSaleProducts(ps: unknown): Array<{
    productId?: string;
    name?: string;
    productName?: string;
    unit?: "box" | "pcs";
  ...
  function getSaleMeta(ps: unknown): {
    shop_address?: string;
    shop_phone?: string;
  } {
    if (!ps) return {};
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="p-3 rounded-lg bg-success-green-light/20 border border-success-green-dark/20">
                    ...
                    <div className="text-lg font-bold text-success-green-dark">
                  ...
                  <Card className="border-0 shadow-strong bg-white print:shadow-none print:border-0">
                    <CardContent className="p-6 sm:p-8 print:p-2">
                      ...
                      <div className="mb-6 print:mb-3 pb-3 border-t border-b border-dashed">
                        ...
                        {getSaleMeta(selectedSale.products_sold)
                          .shop_address && (
                      ...
                      <div className="border-t border-foreground border-dashed pt-3 print:pt-2">
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <span className="text-2xl font-bold text-primary-dark print:text-base">
